...
Derive the filename from the ADR path: `docs/adr-0053-spec-acceptance-loop.md` → `docs/audits/spec-alignment-spec-acceptance-loop-<YYYY-MM-DD>.md`
...
Create `docs/audits/` if it doesn't exist. This is mandatory — evaluation history must be preserved.
